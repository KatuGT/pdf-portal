...
export default function IndexPage() {
  ...
  const checkLoginStatus = () => {
    const cookieValue = Cookies.get("passPortal");

    if (cookieValue === "monshonice3375") {
      setIsLogged(true);
    } else {
      setIsLogged(false);
    }
  ...
  return (
    <DefaultLayout>
      {isLogged ? (
        ...
        <form
          className="border p-10 rounded-md w-fit mx-auto flex flex-col gap-10"
          onSubmit={handleOnSubmit}
        >
          <label>
            <span className="mr-3">Contraseña</span>
            <input className="p-1" name="password" type="password" />
          </label>
